...
## Project Structure
    ...
    ├── testapiautodatamod_119164  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_119164`
...
2. Clone this repo and `cd testapiautodatamod_119164`
